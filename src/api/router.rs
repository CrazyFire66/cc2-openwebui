...
pub fn build_router(
    ...
    let api = Router::new()
        ...
        .route("/api/printer/temperature", post(printer::set_temperatures))
        ...
        .route("/api/printer/timelapse", get(printer::download_timelapse))
        ...
        .route("/api/printer/canvas/load", post(printer::canvas_load))
        .route("/api/printer/canvas/unload", post(printer::canvas_unload))
        .route("/api/printer/canvas/slot", post(printer::canvas_set_slot))
